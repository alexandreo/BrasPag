...
use Alexandreo\Soap\PagadorClient;
...
trait PagadorTransactionService
{

	private $brasPagPagadorClient = null;

	function __construct($envProducation = true)
	{
		$this->brasPagPagadorClient = new PagadorClient([
	...
	public function authorizeTransaction(AuthorizeTransactionContracts $authorizeTransaction)
	{
		...
		return $this->brasPagPagadorClient->authorizeTransaction($request);
	}
	...
	public function captureCreditCardTransaction(CaptureCreditCardTransactionContracts $captureCreditCardTransactionContracts )
	{
		...
		return $this->brasPagPagadorClient->captureCreditCardTransaction($request);
	}
	...
	public function refundCreditCardTransaction(RefundCreditCardTransactionContracts $refundCreditCardTransactionContracts)
	{
		...
		return $this->brasPagPagadorClient->refundCreditCardTransaction($request);
	}
	...
	public function voidCreditCardTransaction(VoidCreditCardTransactionContracts $voidCreditCardTransactionContracts)
	{
		...
		return $this->brasPagPagadorClient->voidCreditCardTransaction($request);
	}
	...
	{
		return [
			'request' => $this->brasPagPagadorClient->xmlRequest,
			'reponse' => $this->brasPagPagadorClient->xmlReponse,
		];
	}
